...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['id']) && isset($_POST['event']) && ($_POST['event'] === 'ELEX-A-THON' || $_POST['event'] === 'MECH-A-THON')) {
    ...
    "error": "Error: ID not found in the database or not participating in the specified event"
        ...
        echo '{
    "status": false,
    "error": "Error: id and event parameters are required and event parameter must be either ELEX-A-THON or MECH-A-THON."
}';
    }
} else {
    echo '{
