...
$select_elex_registrations = mysqli_query($conn, "SELECT * FROM `participants` WHERE event = 'MECH-A-THON'") or die('query failed');
                        ...
                        <div class="card-body mt-4">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-hover" id="elextable">
                                    ...
                                    <?php
                                    $select_users = mysqli_query($conn, "SELECT * FROM `participants` WHERE event = 'MECH-A-THON' ORDER BY `id` ASC") or die('query failed');
